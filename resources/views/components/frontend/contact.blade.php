        ...
        <div class="flex flex-col md:flex-row md:gap-x-8">
            ...
            <div class="flex flex-col lg:flex-row gap-x-4">
                ...
                <div>
                    ...
                    <p class="text-accent font-normal">Email me at yahyaouiaziz131@gmail.com</p>
                </div>
            </div>
            <div class="flex flex-col lg:flex-row gap-x-4">
                <div
                ...
                <div>
                    ...
                    <p class="text-paragraph mb-1">Siliana , Tunisia</p>
                    <p class="text-accent font-normal">Serving clients worldwide.</p>
                </div>
            </div>
            </div>
            <form x-data="form" @submit.prevent="submitForm" action="/contact" class="space-y-8 w-full max-w-md">
                <div x-show="showMessage"
                    class="p-4  text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
             ...
             <div class="flex gap-8">
                ...
                <textarea name="body" x-model="form.body" class="textarea" placeholder="Your Message" spellcheck="flase"></textarea>
