<section id="home" class="section flex items-center bg-light-primary dark:bg-dark-primary lg:h-[85vh] overflow-hidden">
    <div class="container mx-auto h-full">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <br>
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Aziz ! 👋</p>
                <h1
                    class="
                        text-4xl
                        leading-[44px]
                ...
                <p
                    ...
                    I try every day to optimize my programming knowledge,
                ...
                <div class="pt-12">
                    ...
                    <div class="flex items-center mb-6">
                        <a class="
                                ...
                                sm:mr-4
                                "
                            href="https://www.facebook.com/Yahyaoui.Med.Aziz0">
                  ...
                  sm:mr-4
                "
                            href="https://twitter.com/yahyaoui_aziz69">
                  ...
                  sm:mr-4
                "
                            href="https://www.youtube.com/channel/UCb0n47axK7Q4lNGcwnLN6WA">
                            <svg width="16" height="12" viewBox="0 0 16 12" class="fill-current">
                                <path
                  ...
                  sm:mr-4
                "
                            href="https://www.linkedin.com/in/yahyaoui-mohamed-aziz-51a277240/">
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                <img class="rounded-lg" src="/img/azizo.jpg" alt="Azizo img" />
            </div>
        </div>
    </div>
</section>
